//! All prompt templates used by `adept_score`, gathered in one module so
...
//! new [`crate::report::ScoreReport`]s can be told apart.

/// A version string stamped into every [`crate::report::ScoreReport`],
